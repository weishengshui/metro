...
<script type="text/javascript">
	...
	function submitLine(){
		if($('#lineForm').form('validate')){
			...
			if(flag){return false;}
			accept();
			var siteJson = JSON.stringify($('#dg').datagrid('getChanges', "inserted"));
	        var param = $("#lineForm").serialize();
	        if(siteJson=='[]'){siteJson = ''};
	        $.post("saveLine?"+param+"&siteJson="+siteJson, function(rsp) {
	  ...
	  <fieldset style="font-size:14px;">
	  	...
	  	<table>
	  		<tr>
	  			...
	  			<td>
	  				<input id="numno" type='text' name='numno' style="width:200px" maxlength="20" 
        ...
        <thead>
            <tr>
                ...
                <th data-options="field:'name',width:250,align:'left'">站台名称</th>          
